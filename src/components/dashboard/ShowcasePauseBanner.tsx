    ...
    <div className="flex flex-col gap-3 w-full">
      ...
      <div className="flex items-center justify-between px-0.5">
        ...
        <button
          ...
          aria-label="메뉴"
          onClick={() => router.push("/magazine")}
          className="p-1 text-gray-400 hover:text-gray-900 transition-colors rounded-lg active:scale-95 outline-none"
      ...
      {/* 잠시멈춤 매거진 배너 카드 -> /magazine/11 */}
      <div
        onClick={() => router.push("/magazine/11")}
        className="bg-[#F9FAFB] hover:bg-[#F2F4F7] border border-gray-200/60 hover:border-emerald-300 rounded-2xl p-4 flex items-center justify-between cursor-pointer transition-all active:scale-[0.98]"
      >
