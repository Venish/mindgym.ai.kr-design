    ...
    <div className="w-full min-h-screen bg-theme-app txt-brand-ink text-left select-text flex flex-col font-sans">
      ...
      <main className="flex-1 p-6 overflow-y-auto no-scrollbar">
        <div className="flex flex-col gap-6 text-xs text-theme-muted leading-relaxed">
          <section>
            <h2 className="text-sm font-bold txt-brand-ink mb-2">제1조 (목적)</h2>
            <p>
          ...
          <section>
            <h2 className="text-sm font-bold txt-brand-ink mb-2">제2조 (용어의 정의)</h2>
          ...
          <section>
            <h2 className="text-sm font-bold txt-brand-ink mb-2">제3조 (약관의 효력 및 변경)</h2>
            <ol className="list-decimal list-inside space-y-1.5 pl-1">
