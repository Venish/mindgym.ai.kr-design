    ...
    <div className={`inline-flex items-center justify-center ${className}`}>
      <style>{`
        ...
        .animated-text-path {
          ...
          animation: textWavePulse 1.8s ease-in-out infinite;
        }
        .letter-M1 { animation-delay: 0.0s; }
        .letter-I  { animation-delay: 0.12s; }
        .letter-N  { animation-delay: 0.24s; }
        .letter-D  { animation-delay: 0.36s; }
        .letter-G  { animation-delay: 0.48s; }
        .letter-Y  { animation-delay: 0.60s; }
        .letter-M2 { animation-delay: 0.72s; }
      `}</style>
      <svg
        height={height}
        width={Math.round(height * (399 / 110))}
        viewBox="0 0 399 110"
        fill="none"
      ...
      >
        {/* 1. M (첫 글자) */}
        <path
          className="animated-text-path letter-M1"
        ...
        {/* 2. I */}
        <path
          className="animated-text-path letter-I"
          d="M81.41 75.85H93.28V25.01H81.41V75.85Z"
          fill="black"
        />
        {/* 3. N */}
        <path
          className="animated-text-path letter-N"
        ...
        {/* 4. D */}
        <path
          className="animated-text-path letter-D"
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        {/* 5. G */}
        <path
          className="animated-text-path letter-G"
          fillRule="evenodd"
          clipRule="evenodd"
        ...
        {/* 6. Y */}
        <path
          className="animated-text-path letter-Y"
        ...
        {/* 7. M (마지막 글자) */}
        <path
          className="animated-text-path letter-M2"
