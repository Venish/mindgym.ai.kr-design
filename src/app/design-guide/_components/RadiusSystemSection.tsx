        ...
        {radiusList.map((item) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 shrink-0">
              <div
                className={`w-16 h-16 bg-gradient-to-br from-emerald-50 to-teal-100/60 flex items-center justify-center font-mono font-black text-xs text-[var(--color-forest-green)] shadow-2xs ${item.class}`}
              >
                {item.class}
              </div>
              <div>
            ...
            <div className="flex flex-col justify-center border-t md:border-t-0 md:border-l border-gray-100 pt-3 md:pt-0 md:pl-6 max-w-lg">
              ...
              <span className="txt-caption-sub text-gray-500 mt-1 font-medium leading-relaxed">
