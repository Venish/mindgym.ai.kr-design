  ...
  const cssTypographyTypes = [
    {
      ...
      size: "clamp(1.375rem, 5vw, 1.625rem) [22px ~ 26px 모바일 반응형]",
      weight: "Font ExtraBold (800)",
      desc: "360px 모바일(22px)부터 대형 디바이스(26px)까지 유연하게 축소/확대되는 반응형 메인 타이틀 (text-wrap: balance)",
      sample: "나만의 맞춤 마음 근력 리추얼로 일상을 채워보세요",
    },
    {
      className: ".txt-title-section",
      name: "2. Section Header (섹션 타이틀)",
      size: "clamp(1.25rem, 4.5vw, 1.375rem) [20px ~ 22px 모바일 반응형]",
    ...
    },
    {
      ...
      size: "clamp(1.125rem, 4vw, 1.25rem) [18px ~ 20px 모바일 반응형]",
      weight: "Font Bold (700)",
      desc: "모바일 화면 크기에 비례하여 카드 내 찌그러짐 없이 렌더링되는 카드 제목",
      sample: "아침 3분 마인드풀니스 명상 및 호흡 루틴",
    },
    {
      className: ".txt-body-main",
      name: "4. Body Main Text (기본 본문)",
      size: "clamp(1.0rem, 3.5vw, 1.125rem) [16px ~ 18px 모바일 반응형]",
      weight: "Font Medium (500)",
      desc: "스마트폰 소형 화면에서 답답함 없는 16px 가독성 표준 기반 기본 본문 (line-height: 1.6)",
      sample: "직장 스트레스 감소와 집중력 향상을 위해 매일 아침 간단한 리추얼을 실천해 보세요. 덤벨 보상이 누적됩니다.",
    },
    {
      className: ".txt-caption-main",
      name: "5. Body Sub & Caption (서브 캡션)",
      size: "clamp(0.875rem, 3vw, 1.0rem) [14px ~ 16px 모바일 반응형]",
    ...
    },
    {
      ...
      size: "clamp(0.75rem, 2.5vw, 0.875rem) [12px ~ 14px 모바일 반응형]",
      weight: "Font Bold (700)",
