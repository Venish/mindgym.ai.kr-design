      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between items-center">
            ...
            <span className="text-[10px] text-gray-400 font-bold">마우스 움직임 동적 추적</span>
          </div>

          <SpotlightCard
            spotlightColor="rgba(0, 196, 116, 0.25)"
            className="group relative bg-white border border-gray-200/90 rounded-3xl p-7 shadow-xs hover:shadow-2xl hover:border-[#00C474] transition-all duration-500 overflow-hidden cursor-pointer"
          >
            ...
            <div className="relative z-10 flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-black text-[#00C474] bg-emerald-50 border border-emerald-200 px-3 py-1 rounded-full flex items-center gap-1.5 shadow-2xs">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#191F28] tracking-tight leading-snug">
                  마우스를 올려 오로라 이펙트를 <br />
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <button className="bg-[#00C474] group-hover:bg-[#00B068] text-white font-extrabold text-xs px-4 py-2.5 rounded-xl transition-all flex items-center gap-1.5 shadow-sm group-hover:shadow-md">
                  <span>자세히 보기</span>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between items-center">
            ...
            <span className="text-[10px] text-gray-400 font-bold">오로라 그라데이션 글로우</span>
          </div>
          ...
          <div className="group relative rounded-3xl p-[1.5px] bg-gradient-to-r from-gray-200 via-gray-200 to-gray-200 hover:from-[#00C474] hover:via-teal-400 hover:to-indigo-500 transition-all duration-700 shadow-xs hover:shadow-[0_10px_35px_rgba(0,196,116,0.22)] cursor-pointer">
            ...
            <div className="relative z-10 bg-white group-hover:bg-gradient-to-br group-hover:from-white group-hover:via-emerald-50/30 group-hover:to-teal-50/20 rounded-[23px] p-7 transition-all duration-500 flex flex-col gap-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-extrabold text-indigo-700 bg-indigo-50 border border-indigo-200 px-3 py-1 rounded-full flex items-center gap-1.5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2 leading-relaxed">
                  카드 테두리 전체가 그라데이션 빔으로 둘러싸이며, 내부 패널이 오로라 틴트로 부드럽게 전환되는 메인 대시보드형 히어로 컴포넌트입니다.
                </p>
              </div>
