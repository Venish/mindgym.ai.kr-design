...
/**
 * 3. ShowcaseBentoGrid: 이달의 리추얼(미소 명상 아이콘 크기 w-10 h-10 정갈하게 축소) & 30초 체크인 2열 벤토 모듈
 */
export function ShowcaseBentoGrid({}: ShowcaseBentoGridProps) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3.5">
      {/* [1열 - 왼쪽] 이달의 리추얼 카드 (미소 명상 3D 아이콘 크기 w-10 h-10 축소) */}
      <div
        onClick={() => router.push("/player/RT-001")}
        className="bg-white border border-gray-200/90 rounded-2xl p-3.5 shadow-2xs flex flex-col justify-between min-h-[136px] relative overflow-hidden group hover:border-[var(--color-forest-green)] transition-all cursor-pointer active:scale-[0.98]"
      >
        <div className="flex flex-col gap-1.5 relative z-10">
          ...
          {/* 미소 명상 3D 그래픽 아이콘 (w-10 h-10 아담하게 축소) */}
      ...
      <div
        ...
        className="bg-white border border-gray-200/90 rounded-2xl p-4 shadow-2xs flex flex-col justify-between hover:border-[var(--color-forest-green)] transition-all cursor-pointer group min-h-[136px] active:scale-[0.98]"
      >
