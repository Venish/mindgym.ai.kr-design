    ...
    <main className="min-h-screen bg-white txt-brand-ink font-sans flex flex-col items-center justify-start relative pb-24">
      ...
      <div className="w-full max-w-[430px] min-h-screen bg-white flex flex-col relative border-x border-gray-200/60 shadow-xs">
        ...
        <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md px-5 py-4 flex items-center justify-between">
          ...
          {/* 우측 덤벨 캡슐 뱃지 [🏋️ 철 · 12회] */}
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#F9FAFB] rounded-full shadow-2xs">
        ...
        <div className="flex-1 flex flex-col gap-6 px-5 pt-1 pb-6">
          ...
          <section className="bg-[#E9F8F0] rounded-3xl p-6 flex flex-col items-center text-center shadow-2xs relative overflow-hidden">
            ...
            <div className="w-32 h-32 rounded-full bg-white border-4 border-emerald-100 flex flex-col items-center justify-center mb-5 shadow-2xs">
              <span className="text-3xl font-black txt-brand-green-accent tracking-tight leading-none">
                5:00
              </span>
              <span className="text-[11px] font-bold txt-brand-forest mt-1">
                오늘의 운동
              </span>
            </div>
            ...
            <p className="text-xs font-semibold txt-brand-forest mt-1 mb-6 leading-relaxed max-w-[240px]">
              화면 밖에서 보내는 5분, <br />
              생각이 천천히 가라앉아요
            </p>
          ...
          <section className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div
                ...
                className="cursor-pointer bg-[#F9FAFB] rounded-2xl p-4 flex flex-col justify-between h-[105px] transition-all shadow-2xs active:scale-97 text-left"
              >
