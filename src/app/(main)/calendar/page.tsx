...
export default function CalendarPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-white flex flex-col select-none relative pb-12 text-gray-900">
      ...
      <div className="flex flex-col w-full px-5 pt-3 gap-6 text-left max-w-lg mx-auto">
        ...
        <div className="w-full flex flex-col gap-3">
          <div className="flex items-center justify-between px-1">
            <h2 className="text-[0.9375rem] font-bold text-gray-900 tracking-tight flex items-center gap-1.5">
