...
export default function CalendarPage() {
  ...
  // 2026년 8월 1일은 토요일(index 6)부터 시작 (빈 칸 6개)
  ...
  return (
    <div className="w-full min-h-screen bg-theme-app flex flex-col select-none relative pb-12 txt-brand-ink transition-colors duration-300">
      {/* 1. 상단 서브 헤더 (뒤로가기 클릭 시 /dashboard 라우트 이동) */}
      <SubPageHeader
        title="월간 출석 달력"
        leftType="back"
        leftHref="/dashboard"
      ...
      <div className="flex flex-col w-full px-5 pt-3 gap-6 text-left max-w-lg mx-auto">
        ...
        <div className="w-full flex flex-col gap-3">
          <div className="flex items-center justify-between px-1">
            <h2 className="text-[0.9375rem] font-bold txt-brand-ink tracking-tight flex items-center gap-1.5">
              <span>{userName}님의 8월 출석 현황</span>
            </h2>
